...
function rollDice() {
  return new Promise((resolve, reject) => { // Compute a random number of rolls (3-10) that the dice MUST complete
...
// it stops the function without going to the next condition