...
function main() {
  ...
  const partnerNames = ['Paula', 'Cora', 'Maya', 'Taylor', 'Stella'];

  const locations = ['France', 'Italy', 'England', 'Germany', 'Netherlands'];

  const jobTitles = ['Lawyer', 'Engineer', 'Psychologist', 'Doctor', 'Nurse'];
