...
function main() {
  ...
  const partnerNames=['Tom','Veli','Jason','Jessica','Ali']

  const locations=['Amsterdam','Roterdam','Almelo','Zwolle','Deventer']

  const jobTitles=['Teacher','Engineer','Doctor','Developer','Cleaner']
