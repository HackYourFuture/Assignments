...
-----------------------------------------------------------------------------*/
const numKids = [3, 2, 6, 0, 6];
const partnerNames = ['Monique', 'Mary', 'Sara', 'Barbara', 'Johanna'];
const locations = ['Amsterdam', 'Istanbul', 'Paris', 'Tokyo', 'London'];
const jobTitles = ['DevOp', 'Tester', 'DA', 'BA', 'Hacker'];
