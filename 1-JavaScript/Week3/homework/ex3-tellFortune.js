...
function main() {
  ...
  const partnerNames = ['John', 'Sam', 'Lara', 'Andy', 'Kite'];

  const locations = ['Italy', 'Spain', 'Brazil', 'Japan', 'Netherlands'];

  const jobTitles = ['Developer', 'Engineer', 'Artist', 'Doctor', 'Professor'];
