...
const partnerNames = ['Jose', 'Maria', 'Ana', 'Ivan', 'Sara'];

const locations = ['Amsterdam', 'Paris', 'Berlin', 'The Hague', 'Lisbon'];

const jobTitles = ['dentist', 'developer', 'teacher', 'doctor', 'lawyer'];
