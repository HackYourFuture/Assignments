...
function main() {
  ...
  const partnerNames =  ["Emma", "Alex", "Grace", "Liam", "Zoe"];


  const locations = ["Rio de Janeiro", "Cape Town", "Dubai", "Vancouver", "Mumbai"];


  const jobTitles = ["chef", "pilot", "scientist", "entrepreneur", "photographer"];
