...
function main() {
  console.log(calculateDogAge(10)); // -> "Your doggie is 7 years old in dog years!"
  console.log(calculateDogAge(12)); // -> "Your doggie is 14 years old in dog years!"
  console.log(calculateDogAge(13)); // -> "Your doggie is 21 years old in dog years!"
}
