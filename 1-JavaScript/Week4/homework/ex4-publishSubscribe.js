...
function createPublisher() {
    ...
    return {
        subscribe(subs) {
            // Pushed the candidate subscribers to the subscribers array.
            return subscribers.push(subs);
        },
        notify(message) {
            // Iterated through the subscribers array. Called them and passed a message.
            return subscribers.forEach((func) => func(message));
        },
    };
}
